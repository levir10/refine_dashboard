...
import { Task } from "@/graphql/schema.types"; // Adjust this import
...
export const TitleForm = ({ initialValues, isLoading }: Props) => {
  ...
  useEffect(() => {
    setTitle(initialValues.title); // Sync with the initial values
  }, [initialValues.title]);

  const handleTitleChange = (newTitle: string) => {
    initialValues.title=newTitle;
    setTitle(newTitle);
    saveTitle(newTitle); // Automatically save the title when it changes
